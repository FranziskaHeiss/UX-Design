...
(function (UXDesign) {
    ...
    function doubleKeyPress(_event) {
        let tropfen = document.getElementById("regentropfen");
        let sonne = document.getElementById("sonne");
        let regenbogen = document.getElementById("regenbogen");
        let imgSonne = document.getElementById("sonne").getElementsByTagName("img")[0];
        let imgTropfen = document.getElementById("regentropfen").getElementsByTagName("img")[0];
        if (tropfen.classList.contains("visible") && sonne.classList.contains("visible")) {
            console.log("Regenbogen wurde gedrückt");
            let s = imgSonne.style;
            s.display = "inline";
            s.width = "670";
            s.height = "470";
            let t = imgTropfen.style;
            t.display = "inline";
            t.width = "670";
            t.height = "470";
